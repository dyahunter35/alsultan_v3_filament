              ...
              <div>
                  ...
                  <div class="font-sans text-gray-800">
                      ...
                      <main class="w-full" id="report-content">
                          <div
                              class="flex items-center justify-center gap-4 xl:gap-60 lg:gap-48 md:gap-16 sm:gap-8 sm:flex-row">
                              <div class="w-full ">
                          ...
                          <div class="overflow-hidden bg-white shadow-lg rounded-xl">
                              ...
                              <div class="overflow-x-auto">
                                  <table class="w-full text-sm text-right text-gray-600">
                                      <!-- Table Head -->
                                      <thead
                                          class="text-xs text-gray-700 uppercase border-b border-gray-200 bg-gray-50">
                                          <tr>
