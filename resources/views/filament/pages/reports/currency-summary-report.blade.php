            ...
            <table class="min-w-full text-sm text-right border-collapse">
                <thead class="font-semibold text-gray-700 bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-green-600 border-b">المطلوبات (مستلمة)</th>
                        <th class="px-4 py-2 text-red-600 border-b">المدفوعات (مرسلة)</th>
                        <th class="px-4 py-2 text-blue-600 border-b">تحويلات (total)</th>
                ...
                <tbody>
                    @forelse($companies as $company)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-2 font-semibold text-green-700 border-b">
                                {{ number_format($company['received'], 2) }}
                            </td>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-4 py-3 text-center text-gray-500">لا توجد بيانات متاحة.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
